...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-sans bg-dark-900 text-gray-100 text-base">
        <nav class="border-b border-dark-800">
            <div class="container px-10 py-6 mx-auto flex flex-col lg:flex-row items-center justify-between">
                <div class="w-3/12 flex items-center mb-6 lg:mb-0 font-semibold uppercase tracking-wider">
                    <a href="{{ route('movies') }}">
                ...
                <div class="w-3/12 flex items-center justify-end mb-6 lg:mb-0 font-semibold uppercase tracking-wider">
                    <a href="{{ route('movies') }}" class="ml-0 lg:ml-16 hover:text-purple-500 transition ease-in-out duration-150">Movies</a>
                </div>
            </div>
        </nav>
        @yield('content')
        <footer class="container mx-auto px-10 py-24">
