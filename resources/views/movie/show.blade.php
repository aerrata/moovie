@extends('layouts.app')
@section('content')
<div class="container flex mx-auto pt-16 flex-col md:flex-row">
    ...
    <div class="mt-6 md:mt-0">
        ...
        <div class="mt-4 flex flex-wrap items-center text-gray-400 text-sm">
            <span class="flex mr-2 mb-3">
                <svg class="h-4 w-4 text-orange-500" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
            </span>
        ...
        <div x-data="{ open: false }" @keydown.escape.window="open = false">
            ...
            <div class="mt-12 flex items-center">
                <button
                    type="button"
                    class="px-6 py-3 flex items-center uppercase tracking-wider font-bold bg-purple-500 text-purple-900 rounded-lg hover:bg-purple-600 hover:text-purple-900 focus:outline-none transition ease-in-out duration-150"
                    @click="open = true"
...
<div class="container mx-auto pt-20 pb-24" x-data="{ open: false, image: '' }" @keydown.escape.window="open = false">
